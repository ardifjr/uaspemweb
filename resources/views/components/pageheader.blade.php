        ...
        <div class="col-md-8 d-flex align-items-center justify-content-md-end flex-wrap">
            ...
            <div class="grid-listview me-2">
                <ul>
                    ...
                    @if(!Route::is(['provider-dashboard','provider-services','provider-coupons','provider-offers','provider-reviews','provider-earnings','provider-services-list']))
                    <li>
                        <a href="{{url('provider-book-details')}}" class="{{ Request::is('provider-book-details') ? 'active' : '' }}">
                            <i class="feather-calendar"></i>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('provider-services')}}" class="{{ Request::is('provider-services') ? 'active' : '' }}">
                            <i class="feather-grid"></i>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('provider-booking')}}" class="{{ Request::is('provider-booking') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{url('provider-services-list')}}" class="{{ Request::is('provider-services-list') ? 'active' : '' }}">
                            <i class="feather-list"></i>
                        </a>
                    </li>
                    @endif
            ...
            <a href="{{url('add-coupon')}}" class="btn btn-primary add-set"><i class="feather-plus"></i> Add Coupon</a>
            @endif
            ...
            @endif
            @if(Route::is(['provider-services','provider-services-list']))
            <a href="{{url('service-information')}}" class="btn btn-primary add-set"><i class="feather-plus me-2"></i>Add Service</a>
            @endif
