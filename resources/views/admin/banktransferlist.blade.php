                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="table-imgname">
                                            <img src="{{ URL::asset('admin_assets/img/invoice.jpg') }}" class="me-2"
                                                alt="img">
                                            <span>#123456</span>
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="badge-inactive">Approved</h6>
                                    </td>
                                    <td class="text-center">
                                        <a class="delete-table" href="javascript:void(0);" data-bs-toggle="dropdown"
                                            aria-expanded="true">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="badge-delete">Rejected</h6>
                                    </td>
                                    <td class="text-center">
                                        <a class="delete-table" href="javascript:void(0);" data-bs-toggle="dropdown"
                                            aria-expanded="true">
