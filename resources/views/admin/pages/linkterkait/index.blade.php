            ...
            <div class="row mb-4 justify-content-between align-items-center">
                ...
                <div class="col-auto d-flex gap-4">
                    <div class="page-headers">
                        <form action="/admin/linkterkait" method="get">
                            @csrf
                    ...
                    <a class="btn btn-primary" href="{{ url('admin/linkterkait/create') }}"><i class="fa fa-plus me-2"></i>Add Link Terkait</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12 ">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ url('admin/linkterkait/' . $item->id) }}"
