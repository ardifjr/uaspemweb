            ...
            <div class="row mb-4 justify-content-between align-items-center">
                ...
                <div class="col-auto d-flex gap-4">
                    <div class="page-headers">
                        <form action="/admin/profilepejabatstruktural" method="get">
                            @csrf
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <img style="max-width: 150px;" src="{{ $item->url_file }}" alt="content">
                                        @endif
                                        </td>
                                        <td>{{ $item->title }}</td>
                                        ...
                                        <td>
                                            <div class="text-center">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ url('admin/profilepejabatstruktural/' . $item->id) }}"
