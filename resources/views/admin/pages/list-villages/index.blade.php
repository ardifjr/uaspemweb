        ...
        <div class="content">
            ...
            <div class="row mb-4 justify-content-between align-items-center">
                ...
                <div class="col-auto d-flex gap-4">
                    ...
                    <a class="btn btn-primary" href="{{ url('admin/list-villages/create') }}"><i class="fa fa-plus me-2"></i>Add List Villages</a>
                </div>
            </div>
            <div class="row">
                <div class="col-12 ">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ url('admin/list-villages/' . $item->id) }}"
